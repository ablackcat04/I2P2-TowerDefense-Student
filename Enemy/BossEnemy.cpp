...
BossEnemy::BossEnemy(int x, int y) : Enemy("play/boss.png", x, y, 25, 35, max_hp, 7500) {
    shield = true;
    triggeredBy1 = false;
    rhythm = 2.f;
}
...
void BossEnemy::Draw() const {
    ...
    al_draw_filled_rounded_rectangle(400, 35, 400+600*(hp/max_hp), 45, 0.2, 0.2, al_map_rgb(255, 25, 25));
}
